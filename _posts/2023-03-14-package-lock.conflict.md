...
For more future-proofing, consider documenting which versions of NPM and Node the project is known to work with. If using NVM, you can create an `.npmrc` file with the output from `node -v`, like so:
